  ...
  return (
    <div>
      <div
        style={{
          background:
            'linear-gradient(rgba(83,115,106,0) 60%, rgba(0,0,0,0.5) 100%), url(&quot',
          width: '100%',
          height: '30vh',
          marginBottom: '50px',
        }}
        ...
        <Container>
          <Row>
            <Col className="col offset-sm-0 offset-md-1 offset-lg-1 offset-xl-2 offset-xxl-2">
              <h1 className="fs-2 text-start" id="dashboardName">
                {firstName} {lastName}
              </h1>
              <h1
                className="fs-3 fw-light text-start"
                id="dashboardEmail"
              ...
              <Button
                className="btn btn-primary dashboardLogout"
                type="button"
                onClick={logout}
              >
                Logout
            ...
            <Col className="col accountAddress">
              ...
              <Row style={{ marginBottom: '16px' }}>
                <Col className="col">
                  ...
                  <p className="d-inline" id="dashboardCity">
                    {city}
                  </p>
                </Col>
              </Row>
