...
export const Basket = () => {
  ...
  function removeFromCart(id:number){
    ...
    if(found){
      ...
      if(true) //replace this with some boolean var named "loggedIn = false"
      ...
      buffer.push(
        <div className="row row-cols-1 row-cols-sm-3 row-cols-md-3 row-cols-lg-5 row-cols-xl-5 row-cols-xxl-5 justify-content-start" style={{background: '#ffffff', borderRadius: '5px', margin: '5px', marginBottom: '30px'}}>
            ...
            <div className="col d-flex d-xxl-flex justify-content-center align-items-center justify-content-xxl-center align-items-xxl-center">
              <h1 className="fs-4" style={{marginTop: '5px'}}> {getNameById(thisProductId)} </h1>
            </div>
  ...
  return (
    ...
    <div style={{width: '100%', height: '90vh', marginBottom: '50px', background: 'linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0))'}}>
        <div className="container d-flex d-xxl-flex justify-content-center align-items-center justify-content-xxl-center align-items-xxl-center" style={{height: '30vh'}}>
          <div className="row">
            <div className="col">
              <h1 className="fs-1 fw-light text-center text-white" id="cartHeadline">Let's see what's in your basket.</h1>
            </div>
          </div>
        </div>
        ...
        <div>{listItems()}</div>
          ...
          <div className="row row-cols-1 row-cols-sm-3 row-cols-md-3 row-cols-lg-5 row-cols-xl-5 row-cols-xxl-5 justify-content-start" style={{background: '#ffffff', borderRadius: '5px', margin: '5px', marginBottom: '30px'}}>
            ...
            <div className="col d-flex justify-content-center align-items-center align-items-xxl-center" />
            <div className="col d-flex justify-content-center align-items-center">
              <p className="fs-4 fw-light" style={{marginTop: '12px'}}>{getCartSize()} items in your cart</p>
            </div>
            <div className="col d-flex d-xxl-flex justify-content-center align-items-center justify-content-xxl-center align-items-xxl-center" style={{padding: '25px'}}>
              <p className="fs-4 fw-bold" style={{marginTop: '12px'}}>Sub-Total: {getTotalPrice()} DKK</p>
            </div>
          </div>
        </div>
